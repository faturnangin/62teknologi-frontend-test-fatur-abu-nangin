...
export default function NavBar() {
    ...
    return (
    <nav ref={nav} className='flex items-center top-0 left-0 w-full bg-grayscale1/70 dark:bg-transparent h-[68px] z-50 dark:border-slate-800 border-grayscale2 dark:transition dark:duration-200'>
        ...
        <div className="w-full px-1 md:px-12 lg:px-20 h-[50px] flex items-center justify-between dark:text-white">
          ...
          <ul className='hidden md:flex space-x-[100px] text-sm font-medium text-deepblue dark:text-grayscale1'>
            <li className='hover:text-blue dark:hover:text-grayscale2'><Link href='/'>Home</Link></li>
            <li className='hover:text-blue dark:hover:text-grayscale2'><Link href='/#main'>Discover</Link></li>
            <li className='hover:text-blue dark:hover:text-grayscale2'><Link href='/#search'>Search</Link></li>
          </ul>
          <ModeToggle/>
        </div>
        </div>
