...
export default function SearchSection() {
  ...
  const handleSubmit = async (e: any) => {
    ...
    try {
      ...
      console.log(
        `https://api.yelp.com/v3/businesses/search?${param}=${value}&limit=3`,
      );
        ...
        <div className="-translate-y-1/2">
          <div className="mx-1 md:mx-12 lg:mx-20 p-5 bg-grayscale1 dark:bg-darkestblue rounded-lg border border-grayscale2 shadow-md flex items-center justify-center">
            ...
            >
              ...
              {/* <button
                type="submit"
                className="flex space-x-1 items-center justify-center p-2 text-sm text-grayscale1 font-medium rounded-xl bg-blue"
              >
                <Globe2 />
