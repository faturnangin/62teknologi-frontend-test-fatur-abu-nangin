...
export default function Card({ data }: { data: Business }) {
  ...
  return (
    <div className="p-5 space-y-4 rounded-lg border border-grayscale2 dark:border-grayscale3 bg-grayscale1 hover:bg-blue dark:bg-grayscale4/50 group transition-colors duration-300">
      ...
      <div className="flex flex-col space-y-4">
        <div className="flex flex-col">
          <h5 className="text-lg md:text-xl lg:text-2xl font-semibold text-slate-800 dark:text-grayscale1 group-hover:text-grayscale1 max-w-[320px] truncate">
            {data.name}
          </h5>
